...
class AlunoFilter(filters.FilterSet):
    nome_aluno = filters.CharFilter(field_name='alunos_academia__aluno__nome', lookup_expr='icontains' )
    academia = filters.NumberFilter(field_name='alunos_academia__academia', lookup_expr='exact' )
